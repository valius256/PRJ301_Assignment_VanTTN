...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int id = Integer.parseInt(request.getParameter("txteditid"));
            String name = request.getParameter("txtitemname");
            int price = Integer.parseInt(request.getParameter("txtitemprice"));
            int itemType = Integer.parseInt(request.getParameter("txtitemtype"));
            
            Item item = new Item(id, name, price, itemType);
